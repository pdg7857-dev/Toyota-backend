...
export const POWERTRAINS: PowertrainSeed[] = [
  ...
  { key: "tacoma-i-force-max", type: PowertrainType.HYBRID, displayName: "i-FORCE MAX Hybrid",
  ...
  { key: "tundra-i-force-max", type: PowertrainType.HYBRID, displayName: "i-FORCE MAX Hybrid",
  ...
  { key: "corolla-cross-hybrid-awd", type: PowertrainType.HYBRID, displayName: "2.0L Hybrid AWD",
  ...
  { key: "camry-hybrid-fwd", type: PowertrainType.HYBRID, displayName: "2.5L Hybrid FWD",
  ...
  { key: "camry-hybrid-awd", type: PowertrainType.HYBRID, displayName: "2.5L Hybrid AWD",
  ...
  { key: "rav4-hybrid-awd", type: PowertrainType.HYBRID, displayName: "2.5L Hybrid AWD",
  ...
  { key: "highlander-hybrid-awd", type: PowertrainType.HYBRID, displayName: "2.5L Hybrid AWD",
  ...
  { key: "grand-highlander-hybrid-max", type: PowertrainType.HYBRID, displayName: "2.4L Turbo Hybrid MAX AWD",
  ...
  { key: "grand-highlander-hybrid", type: PowertrainType.HYBRID, displayName: "2.5L Hybrid AWD",
  ...
  { key: "crown-hybrid", type: PowertrainType.HYBRID, displayName: "2.5L Hybrid AWD",
  ...
  { key: "crown-hybrid-max", type: PowertrainType.HYBRID, displayName: "2.4L Turbo Hybrid MAX AWD",
  ...
  { key: "crown-signia-hybrid", type: PowertrainType.HYBRID, displayName: "2.5L Hybrid AWD",
  ...
  { key: "sienna-hybrid", type: PowertrainType.HYBRID, displayName: "2.5L Hybrid",
  ...
  { key: "prius-hybrid-awd", type: PowertrainType.HYBRID, displayName: "2.0L Hybrid AWD",
    engineDesc: "2.0L 4-cyl + electric motors", horsepowerHp: 196, torqueLbft: 152,
    transmission: "eCVT", drivetrain: "AWD (AWD-e)",
